          ...
          >
            <span className="relative top-3 block h-11.5 w-10.5 cursor-pointer">
              ...
              <span className="absolute right-0 h-full w-full rotate-45">
                <span
                  className={`absolute bottom-2 left-2.5 block h-full w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white ${
                    !sidebarOpen && "!h-0 !delay-[0]"
                  }`}
                ></span>
                <span
                  className={`delay-400 absolute right-2.5 top-3 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white ${

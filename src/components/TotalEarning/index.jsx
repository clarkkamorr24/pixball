...
const TotalEarning = () => {
  ...
  return (
    <div className="dark:outline-strokedark pt-7.5 outline-stroke sm:px-7.5 col-span-1 rounded-md bg-white px-5 pb-0 outline outline-1 md:col-span-2 xl:col-span-2 xl:row-span-3 dark:bg-black">
      <div className="flex flex-col gap-3">
        <p className="font-semibold text-black dark:text-white">
          Total Earning
        </p>
        <p className="flex justify-center text-3xl font-semibold text-black dark:text-white">
          $6,743.00
        </p>
